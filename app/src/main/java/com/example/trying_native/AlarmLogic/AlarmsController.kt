...
class AlarmsController (private val timeProvider: TimeProvider = TimeProviderImpl()){
    ...
    sealed interface AlarmValueForAlarmSeries{
        data class AlarmData(val alarmData: com.example.trying_native.dataBase.AlarmData): AlarmValueForAlarmSeries
        data class AlarmObject(val alarmObject: com.example.trying_native.dataBase.AlarmObject): AlarmValueForAlarmSeries
    }
        ...
        return ResultCustom.runCatching(
            ...
            val alarmData: AlarmData = when (alarm) {
                ...
                is AlarmValueForAlarmSeries.AlarmObject -> {
                    val insertId =
                        alarmDao.insert(alarm.alarmObject.toAlarmData(id = 0, isReadyToUse = true))
